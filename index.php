      ...
      <section id="publications">
         <div class="container">
            <div class="row">
		     ...
		     <?php
                     foreach ($jsonPublicacoes as $pub) {
			//echo $pub['link'] . '<br/>';
		     }
	             ?>
               ...
               <div class="col-md-12 p-2 " >
                  <div id="demo" class="carousel slide" data-ride="carousel">
                     ...
                     <div class="carousel-inner" role="listbox">
                           <div class="carousel-item active">
						   <a target="_blank" class="del-style-link w-100" href="<?php echo $jsonPublicacoes[0]['link'] ?>" data-toggle="modalD" data-target="#modal_titulo1">
                               <img class="w-100" src=<?php  $imgname = 'admin/publicacoes/imagens/'.$jsonPublicacoes[0]['imagem'].'.jpg'; echo $imgname ?>  alt="CMG USP">
                           ...
                           <div class="carousel-item">
						   <a target="_blank" class="del-style-link w-100" href="<?php echo $jsonPublicacoes[1]['link'] ?>" data-toggle="modalD" data-target="#modal_titulo2">
                              <img class="w-100 " src=<?php $imgname = 'admin/publicacoes/imagens/'.$jsonPublicacoes[1]['imagem'].'.jpg'; echo $imgname  ?>  alt="CMG USP" >
                              <div class="carousel-caption">
                           ...
                           <div class="carousel-item">
						   <a target="_blank" class="del-style-link w-100" href="<?php echo $jsonPublicacoes[2]['link'] ?>" data-toggle="modalD" data-target="#modal_titulo2">
                              <img class="w-100" src=<?php  $imgname = 'admin/publicacoes/imagens/'.$jsonPublicacoes[2]['imagem'].'.jpg'; echo $imgname  ?>  alt="CMG USP" >
                              <div class="carousel-caption">
...
<div class="row">
	<div class="col text-center col-lg-3 col-sm-12">
		<i class="fa fa-phone fa-3x sr-contact"></i>
		<p>(016) 3602-2410</p>
	</div>
	<div class="col text-center col-lg-3 col-sm-12">
		<i class="fa fa-envelope-o fa-3x sr-contact"></i>
		<p><a href="mailto:sec-cmg@hcrp.usp.br">sec-cmg@hcrp.usp.br</a></p>
	</div>
	<div class="col text-center col-lg-3 col-sm-12">
		<i class="fa fa-facebook fa-3x sr-contact"></i>
		<p><a href="https://www.facebook.com/CentroDeMedicinaGenomica/">CentroDeMedicinaGenomica</a></p>
	</div>
	<div class="col text-center col-lg-3 col-sm-12">
		<i class="fa fa-map-marker fa-3x sr-contact"></i>
		<p><a href="https://goo.gl/maps/eLcczySpNby">Av. Bandeirantes, 3900 Ribeirão Preto/SP</a></p>
	</div>
