    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        s = (function(t) {
                var e = "alert",
                    ...
                    ();
                return t(document).on(d.CLICK_DATA_API,
                        u.DISMISS,
                ...
                var e = "carousel",
                    ...
                    T = function() {
                        ...
                        return h.prototype.next = function() {
                            ...
                            h.prototype._getItemByDirection = function(t,
                                e) {
                                var n = t === p.NEXT,
                                    i = t === p.PREVIOUS,
                            ...
                            h.prototype._triggerSlideEvent = function(e,
                                n) {
                    ...
                    ();
                return t(document).on(m.CLICK_DATA_API,
                        v.DATA_SLIDE,
                ...
                var e = "collapse",
                    ...
                    E = function() {
                        ...
                        return l.prototype.toggle = function() {
                                    ...
                                    if (this._parent && (n = t.makeArray(t(this._parent).find(m.ACTIVES)), n.length || (n = null)), !(n && (i = t(n).data(a), i && i._isTransitioning))) {
                                        ...
                                        if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                                            ...
                                            var c = s[0].toUpperCase() + s.slice(1),
                                                d = "scroll" + c;
                                            t(this._element).one(r.TRANSITION_END,
                                                    h).emulateTransitionEnd(u),
                                ...
                                if (t(this._element).hasClass(g.SHOW)) {
                                    ...
                                    if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                                        ...
                                        return this._element.style[i] = "",
                                            r.supportsTransitionEnd() ? void t(this._element).one(r.TRANSITION_END,
                                                s).emulateTransitionEnd(u) : void s()
                                    }
                                }
                            },
                            ...
                            l.prototype._addAriaAndCollapsedClass = function(e,
                                n) {
                                if (e) {
                    ...
                    ();
                return t(document).on(_.CLICK_DATA_API,
                        m.DATA_TOGGLE,
                        function(e) {
                            e.preventDefault();
            ...
            function(t) {
                var e = "dropdown",
                    ...
                    m = function() {
                        ...
                        return e.prototype.toggle = function() {
                                ...
                                var r = {
                                    ...
                                    s = t.Event(_.SHOW,
                                        r);
                                return t(n).trigger(s), !s.isDefaultPrevented() && (this.focus(),
                                    this.setAttribute("aria-expanded", !0),
                                    t(n).toggleClass(g.SHOW),
                                    t(n).trigger(t.Event(_.SHOWN,
                                        r)), !1)
                            },
                            e.prototype.dispose = function() {
                            ...
                            e._clearMenus = function(n) {
                                if (!n || n.which !== f) {
                                    ...
                                    for (var o = t.makeArray(t(p.DATA_TOGGLE)), r = 0; r < o.length; r++) {
                                        ...
                                        if (t(s).hasClass(g.SHOW) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "focusin" === n.type) && t.contains(s,
                                                n.target))) {
                    ...
                    ();
                return t(document).on(_.KEYDOWN_DATA_API,
                        p.DATA_TOGGLE,
                        m._dataApiKeydownHandler).on(_.KEYDOWN_DATA_API,
                        p.ROLE_MENU,
                        m._dataApiKeydownHandler).on(_.KEYDOWN_DATA_API,
                        p.ROLE_LISTBOX,
                        m._dataApiKeydownHandler).on(_.CLICK_DATA_API + " " + _.FOCUSIN_DATA_API,
                        m._clearMenus).on(_.CLICK_DATA_API,
                        p.DATA_TOGGLE,
                        m.prototype.toggle).on(_.CLICK_DATA_API,
                        p.FORM_CHILD,
                        function(t) {
                            t.stopPropagation()
                        }
            ...
            function(t) {
                var e = "modal",
                            ...
                            h.prototype.show = function(e) {
                                ...
                                t(this._element).trigger(i),
                                    this._isShown || i.isDefaultPrevented() || (this._isShown = !0,
                                        ...
                                        t(this._element).on(p.CLICK_DISMISS,
                                            E.DATA_DISMISS,
                                            function(t) {
                                                return n.hide(t)
                                            }
                            ...
                            h.prototype._showBackdrop = function(e) {
                                ...
                                if (this._isShown && this._config.backdrop) {
                                    ...
                                    if (this._backdrop = document.createElement("div"), this._backdrop.className = m.BACKDROP, i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(p.CLICK_DISMISS, function(t) {
                                        ...
                                        t(this._backdrop).addClass(m.SHOW), !e) return;
                                    if (!o) return void e();
                                    t(this._backdrop).one(r.TRANSITION_END,
                                        e).emulateTransitionEnd(d)
                                } else if (!this._isShown && this._backdrop) {
                                    t(this._backdrop).removeClass(m.SHOW);
                                    var s = function() {
                                        n._removeBackdrop(), e && e()
                                    };
                                    r.supportsTransitionEnd() && t(this._element).hasClass(m.FADE) ? t(this._backdrop).one(r.TRANSITION_END,
                                        s).emulateTransitionEnd(d) : s()
                                } else e && e()
                            },
                    ...
                    ();
                return t(document).on(p.CLICK_DATA_API,
                        E.DATA_TOGGLE,
                        function(e) {
                            var n = this,
                                i = void 0,
                    ...
                    _ = function() {
                        ...
                        return e.prototype.show = function() {
                                ...
                                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(d.ACTIVE) || t(this._element).hasClass(d.DISABLED))) {
                                    ...
                                    if (i && t(i).trigger(a),
                                        t(this._element).trigger(l), !l.isDefaultPrevented() && !a.isDefaultPrevented()) {
                            ...
                            e.prototype._activate = function(e,
                                ...
                                s && a ? t(s).one(r.TRANSITION_END,
                                        l).emulateTransitionEnd(c) : l(),
                                    s && t(s).removeClass(d.SHOW)
                            },
                            e.prototype._transitionComplete = function(e,
                                n,
                                i,
                                o) {
                                if (n) {
                ...
                var e = "tooltip",
                    ...
                    I = function() {
                        ...
                        return h.prototype.enable = function() {
                            ...
                            h.prototype.show = function() {
                                ...
                                if (this.isWithContent() && this._isEnabled) {
                                    ...
                                    if (r.supportsTransitionEnd() && t(this.tip).hasClass(m.FADE)) return this._isTransitioning = !0,
                                        void t(this.tip).one(r.TRANSITION_END,
                                            d).emulateTransitionEnd(h._TRANSITION_DURATION);
                                    d()
                                }
                            },
                            h.prototype.hide = function(e) {
                                ...
                                t(this.element).trigger(o),
                                    o.isDefaultPrevented() || (t(i).removeClass(m.SHOW),
                                        ...
                                        r.supportsTransitionEnd() && t(this.tip).hasClass(m.FADE) ? (this._isTransitioning = !0,
                                            t(i).one(r.TRANSITION_END,
                                                s).emulateTransitionEnd(c)) : s(),
                                        this._hoverState = "")
                            },
                            ...
                            h.prototype.setElementContent = function(e,
                                n) {
