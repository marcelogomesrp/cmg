   ...
   <body id="page-top">
      ...
      <nav class="navbar fixed-top navbar-toggleable-md navbar-light navbar-shrink " id="mainNav">
         ...
         <div class="container" id="top">
            ...
            <img id="logo" src="img/logo_.png" class="logo_cinza mini_logo " >
            </a>
      ...
      <header class="masthead" class="container">
                  <img src="img/logo_cmg.png" class="logo-edit"> 
		<div class="logo-edit" />
                   <!-- <img src="img/logo_parceiros.png" class="logo-edit"> -->	
      </header>
      <section id="services" style="border-bottom: 1px solid #DDDDDD; background-color: #eee;" class="bg-gray">
         <div class="container">
            <div class="row">
      ...
      <footer class="container-fluid text-center bg-dark" style="botton:">
         ...
         <p>&copy; Copyright 2018 - <a href="http://www.google.com.br" title="Acesse Nosso Site">Diet Code</a> | Todos os direitos reservados.</p>
      </footer>
	  <!-- Plugin JavaScript  -->
